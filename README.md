...
Paste this: `https://github.com/forcepusher/com.bananaparty.unislop.git#2.0.0`  
...
The server is started automatically at `http://127.0.0.1:5107/mcp`, but your can also enable the status bar.  
